...
export default class YoutubeFeedWidget extends Widget {
  ...
  content() {
    const ytWidth = app.forum.attribute('justoverclock-youtube-video-feed.ytWidth') || '320';
    const ytHeight = app.forum.attribute('justoverclock-youtube-video-feed.ytHeight') || '160';
    const ytChannelId = app.forum.attribute('justoverclock-youtube-video-feed.ytChannelId') || 'UClajUb4K2-HR-QdaIACuHjg';
    return (
      <div class="youtube-feed">
        ...
        <iframe class="latestVideoEmbed" vnum='2' cid="UClajUb4K2-HR-QdaIACuHjg" width={ytWidth} height={ytHeight} frameborder="0" allowfullscreen></iframe>
      </div>
    );
  }
}
